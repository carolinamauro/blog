  ...
  return (
    <section id="contact" className="section-shell relative overflow-hidden py-20">
      ...
      <div
        ...
        style={{ top: "0", left: "10%", width: "24rem", height: "24rem", background: "rgba(129,140,248,0.10)", zIndex: 0 }}
      />
      <div
        className="nebula-blob animate-nebula"
        style={{ bottom: "0", right: "8%", width: "22rem", height: "22rem", background: "rgba(244,114,182,0.10)", zIndex: 0, animationDelay: "4s" }}
      />
